...
const NewIssuePage = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<IssueForm>( //specify shape of our form inside<> --->we called that func and get and obj; we destructure that obj to grab register func
  ...
  return (
    <div className="max-w-xl">
      ...
      >
        ...
        {/* {errors.title && (   ------> we're including this check in out ErrorMessage component */}
          {/* // <Text color="red" as="p"> */}
